...
router
    .route('/')
    .get(run_contest_constroller_1.RunContestController.getAllRunContest)
    .post((0, authMiddleware_1.default)(users_1.ENUM_USER_ROLE.ADMIN), (0, validateRequestZod_1.default)(run_contest_validation_1.RunContestValidation.createRunContestZodSchema), run_contest_constroller_1.RunContestController.createRunContest);
router
    .route('/:id')
